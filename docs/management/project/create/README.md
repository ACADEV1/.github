...
1. Add your repository as a git submodule to [app1_p000 dev](https://github.com/ACADEV1/app1_p000) (for development access), and if in a ready state the same to [app1_p000 prod](https://github.com/ACADEV1/app1_p000/tree/prod) (for production access)
